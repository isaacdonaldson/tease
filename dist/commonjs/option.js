...
exports.OptionUnwrapError = exports.None = exports.Some = exports.Option = void 0;
...
exports.Option = {
    ...
    fromNullable(value) {
        ...
        return (0, utils_js_1.isNonNullable)(value)
            ? exports.Option.some(value)
            : exports.Option.none();
    },
};
/**
...
class Some {
     ...
     */
    map(fn) {
        return exports.Option.some(fn(this.value));
    }
    /**
     ...
     */
    filter(pred) {
        return pred(this.value) ? this : exports.Option.none();
    }
    /**
     ...
     */
    okOr(_defaultValue) {
        return result_js_1.Result.ok(this.value);
    }
}
exports.Some = Some;
/**
...
class None {
     ...
     */
    okOr(defaultValue) {
        return result_js_1.Result.err(defaultValue);
    }
}
exports.None = None;
/**
 ...
 */
class OptionUnwrapError extends error_js_1.TaggedError {
