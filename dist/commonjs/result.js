...
exports.Result = {
     ...
     */
    fromNullable(value) {
        return (0, utils_js_1.isNonNullable)(value) ? exports.Result.ok(value) : exports.Result.err("The value provided was Nullable");
    },
    /**
     * Creates a Result for the provided Nullable value.
     * @template T The type of the value.
    ...
    fromNullableWithError(value, error) {
        if ((0, utils_js_1.isNonNullable)(value)) {
            return exports.Result.ok(value);
        }
        else if ((0, utils_js_1.isNonNullable)(error)) {
    ...
    try(fn) {
        try {
            return exports.Result.fromNullableWithError(fn(), new Error(""));
        }
        catch (e) {
...
class Ok {
     ...
     */
    ok() {
        return option_js_1.Option.fromNullable(this.value);
    }
}
/**
...
class Err {
     ...
     */
    err() {
        return option_js_1.Option.fromNullable(this.error);
    }
    /**
 ...
 * @extends TaggedError
 */
class ResultUnwrapError extends error_js_1.TaggedError {
    constructor() {
        super(...arguments);
 ...
 * @extends TaggedError
 */
class ResultNonNullableError extends error_js_1.TaggedError {
    constructor() {
        super(...arguments);
        this._tag = "ResultNonNullableError ";
    }
}
exports.ResultNonNullableError = ResultNonNullableError;
